...
iconpath = xbmc.translatePath(os.path.join('special://home/addons/script.amaintenance','icon.png'))
...
xbmc.executebuiltin('XBMC.Notification(%s, %s, %s, %s)' % ('Live Tv Tuga Maintenance Status',  'Packages: '+ str(total_sizetext) +  ' MB'  ' - Images: ' + str(total_sizetext2) + ' MB' , '5000', iconpath))